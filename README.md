...
- Owner: `354685856-sn`
- Total stars: `9`
- Generated: `2026-08-02T08:36:11Z`
- Languages: Python (4), TypeScript (3), Unknown (1), Shell (1)
- HTTP date: `Sun, 02 Aug 2026 08:36:11 +0000`
...
| [xingranya/GitHub-Stars-AI-Tools](https://github.com/xingranya/GitHub-Stars-AI-Tools) | TypeScript | 83 | 本地优先的 GitHub Stars AI 桌面应用，可 AI 检索/解析已 Star 项目。Local-first AI desktop app for GitHub Stars. |
...
| [coleam00/claude-memory-compiler](https://github.com/coleam00/claude-memory-compiler) | Python | 1264 | Give Claude Code a memory that evolves with your codebase. Hooks automatically capture sessions, the Claude Agent SDK extracts key decisions and lessons, and an LLM compiler organizes everything into structured, cross-referenced knowledge articles - inspired by Karpathy's LLM Knowledge Base architecture. |
| [coleam00/second-brain-starter](https://github.com/coleam00/second-brain-starter) | Unknown | 704 | Build your own AI Second Brain with Claude Code - a skill that generates a personalized PRD for a proactive, persistent AI assistant |
...
| [heyitsnoah/claudesidian](https://github.com/heyitsnoah/claudesidian) | Python | 2553 | - |
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14486 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
