...
- Owner: `354685856-sn`
- Total stars: `9`
- Generated: `2026-07-26T19:33:24Z`
- Languages: Python (4), TypeScript (3), Unknown (1), Shell (1)
- HTTP date: `Sun, 26 Jul 2026 19:33:24 +0000`
...
| [iansinnott/obsidian-claude-code-mcp](https://github.com/iansinnott/obsidian-claude-code-mcp) | TypeScript | 324 | Connect Claude Code and other AI tools to your Obsidian notes using Model Context Protocol (MCP) |
...
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14344 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
