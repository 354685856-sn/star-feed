...
- Owner: `354685856-sn`
- Total stars: `9`
- Generated: `2026-07-24T19:45:51Z`
- Languages: Python (4), TypeScript (3), Unknown (1), Shell (1)
- HTTP date: `Fri, 24 Jul 2026 19:45:51 +0000`
...
| [coleam00/second-brain-starter](https://github.com/coleam00/second-brain-starter) | Unknown | 696 | Build your own AI Second Brain with Claude Code - a skill that generates a personalized PRD for a proactive, persistent AI assistant |
...
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14308 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
