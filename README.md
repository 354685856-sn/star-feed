...
- Owner: `354685856-sn`
- Total stars: `10`
- Generated: `2026-07-14T08:27:27Z`
- Languages: Python (4), TypeScript (3), Rust (1), Unknown (1), Shell (1)
- HTTP date: `Tue, 14 Jul 2026 08:27:27 +0000`
...
| [coleam00/claude-memory-compiler](https://github.com/coleam00/claude-memory-compiler) | Python | 1244 | Give Claude Code a memory that evolves with your codebase. Hooks automatically capture sessions, the Claude Agent SDK extracts key decisions and lessons, and an LLM compiler organizes everything into structured, cross-referenced knowledge articles - inspired by Karpathy's LLM Knowledge Base architecture. |
...
| [heyitsnoah/claudesidian](https://github.com/heyitsnoah/claudesidian) | Python | 2537 | - |
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14019 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
