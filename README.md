...
- Owner: `354685856-sn`
- Total stars: `9`
- Generated: `2026-07-09T10:22:35Z`
- Languages: TypeScript (3), Python (3), Rust (1), Unknown (1), Shell (1)
- HTTP date: `Thu, 09 Jul 2026 10:22:35 +0000`

## Latest Stars

| Repository | Language | Stars | Description |
| --- | --- | ---: | --- |
| [yanmoais/codex-gateway-lite](https://github.com/yanmoais/codex-gateway-lite) | Rust | 6 | Lightweight Codex Desktop gateway bootstrapper with model catalog, CDP injection, and protocol proxy support. |
| [xingranya/GitHub-Stars-AI-Tools](https://github.com/xingranya/GitHub-Stars-AI-Tools) | TypeScript | 59 | 本地优先的 GitHub Stars AI 桌面应用，可 AI 检索/解析已 Star 项目。Local-first AI desktop app for GitHub Stars. |
...
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 13779 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
