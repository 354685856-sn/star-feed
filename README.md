...
- Owner: `354685856-sn`
- Total stars: `10`
- Generated: `2026-08-22T18:47:48Z`
- Languages: TypeScript (4), Python (4), Unknown (1), Shell (1)
- HTTP date: `Sat, 22 Aug 2026 18:47:48 +0000`
...
| [coleam00/second-brain-starter](https://github.com/coleam00/second-brain-starter) | Unknown | 748 | Build your own AI Second Brain with Claude Code - a skill that generates a personalized PRD for a proactive, persistent AI assistant |
...
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14918 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
