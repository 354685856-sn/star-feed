...
- Owner: `354685856-sn`
- Total stars: `10`
- Generated: `2026-08-09T13:14:47Z`
- Languages: TypeScript (4), Python (4), Unknown (1), Shell (1)
- HTTP date: `Sun, 09 Aug 2026 13:14:47 +0000`
...
| [xingranya/GitHub-Stars-AI-Tools](https://github.com/xingranya/GitHub-Stars-AI-Tools) | TypeScript | 92 | 本地优先的 GitHub Stars AI 桌面应用，可 AI 检索/解析已 Star 项目。Local-first AI desktop app for GitHub Stars. |
| [crimeacs/claude-note](https://github.com/crimeacs/claude-note) | Python | 66 | Your AI pair programmer's memory, synced to Obsidian |
| [iansinnott/obsidian-claude-code-mcp](https://github.com/iansinnott/obsidian-claude-code-mcp) | TypeScript | 330 | Connect Claude Code and other AI tools to your Obsidian notes using Model Context Protocol (MCP) |
...
| [coleam00/second-brain-starter](https://github.com/coleam00/second-brain-starter) | Unknown | 731 | Build your own AI Second Brain with Claude Code - a skill that generates a personalized PRD for a proactive, persistent AI assistant |
...
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14648 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
