...
- Owner: `354685856-sn`
- Total stars: `10`
- Generated: `2026-08-05T14:32:02Z`
- Languages: TypeScript (4), Python (4), Unknown (1), Shell (1)
- HTTP date: `Wed, 05 Aug 2026 14:32:02 +0000`
...
| [xingranya/GitHub-Stars-AI-Tools](https://github.com/xingranya/GitHub-Stars-AI-Tools) | TypeScript | 88 | 本地优先的 GitHub Stars AI 桌面应用，可 AI 检索/解析已 Star 项目。Local-first AI desktop app for GitHub Stars. |
...
| [coleam00/second-brain-starter](https://github.com/coleam00/second-brain-starter) | Unknown | 717 | Build your own AI Second Brain with Claude Code - a skill that generates a personalized PRD for a proactive, persistent AI assistant |
| [ballred/obsidian-claude-pkm](https://github.com/ballred/obsidian-claude-pkm) | Shell | 1733 | A complete starter kit for an Obsidian + Claude Code personal knowledge management system. |
| [heyitsnoah/claudesidian](https://github.com/heyitsnoah/claudesidian) | Python | 2554 | - |
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14562 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
