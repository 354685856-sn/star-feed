...
- Owner: `354685856-sn`
- Total stars: `9`
- Generated: `2026-07-25T14:00:49Z`
- Languages: Python (4), TypeScript (3), Unknown (1), Shell (1)
- HTTP date: `Sat, 25 Jul 2026 14:00:49 +0000`
...
| [coleam00/claude-memory-compiler](https://github.com/coleam00/claude-memory-compiler) | Python | 1257 | Give Claude Code a memory that evolves with your codebase. Hooks automatically capture sessions, the Claude Agent SDK extracts key decisions and lessons, and an LLM compiler organizes everything into structured, cross-referenced knowledge articles - inspired by Karpathy's LLM Knowledge Base architecture. |
...
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14325 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
