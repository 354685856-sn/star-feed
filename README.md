...
- Owner: `354685856-sn`
- Total stars: `10`
- Generated: `2026-08-03T19:56:05Z`
- Languages: TypeScript (4), Python (4), Unknown (1), Shell (1)
- HTTP date: `Mon, 03 Aug 2026 19:56:05 +0000`
...
| [iansinnott/obsidian-claude-code-mcp](https://github.com/iansinnott/obsidian-claude-code-mcp) | TypeScript | 327 | Connect Claude Code and other AI tools to your Obsidian notes using Model Context Protocol (MCP) |
...
| [coleam00/second-brain-starter](https://github.com/coleam00/second-brain-starter) | Unknown | 714 | Build your own AI Second Brain with Claude Code - a skill that generates a personalized PRD for a proactive, persistent AI assistant |
...
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14518 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
