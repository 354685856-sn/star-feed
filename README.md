...
- Owner: `354685856-sn`
- Total stars: `10`
- Generated: `2026-08-23T18:47:25Z`
- Languages: TypeScript (4), Python (4), Unknown (1), Shell (1)
- HTTP date: `Sun, 23 Aug 2026 18:47:25 +0000`
...
| [iansinnott/obsidian-claude-code-mcp](https://github.com/iansinnott/obsidian-claude-code-mcp) | TypeScript | 343 | Connect Claude Code and other AI tools to your Obsidian notes using Model Context Protocol (MCP) |
...
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14931 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
