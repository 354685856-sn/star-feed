...
- Owner: `354685856-sn`
- Total stars: `10`
- Generated: `2026-08-19T07:04:27Z`
- Languages: TypeScript (4), Python (4), Unknown (1), Shell (1)
- HTTP date: `Wed, 19 Aug 2026 07:04:27 +0000`
...
| [coleam00/second-brain-starter](https://github.com/coleam00/second-brain-starter) | Unknown | 740 | Build your own AI Second Brain with Claude Code - a skill that generates a personalized PRD for a proactive, persistent AI assistant |
| [ballred/obsidian-claude-pkm](https://github.com/ballred/obsidian-claude-pkm) | Shell | 1827 | A complete starter kit for an Obsidian + Claude Code personal knowledge management system. |
| [heyitsnoah/claudesidian](https://github.com/heyitsnoah/claudesidian) | Python | 2569 | - |
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14847 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
