...
- Owner: `354685856-sn`
- Total stars: `10`
- Generated: `2026-08-07T19:14:01Z`
- Languages: TypeScript (4), Python (4), Unknown (1), Shell (1)
- HTTP date: `Fri, 07 Aug 2026 19:14:01 +0000`
...
| [coleam00/second-brain-starter](https://github.com/coleam00/second-brain-starter) | Unknown | 728 | Build your own AI Second Brain with Claude Code - a skill that generates a personalized PRD for a proactive, persistent AI assistant |
| [ballred/obsidian-claude-pkm](https://github.com/ballred/obsidian-claude-pkm) | Shell | 1736 | A complete starter kit for an Obsidian + Claude Code personal knowledge management system. |
| [heyitsnoah/claudesidian](https://github.com/heyitsnoah/claudesidian) | Python | 2558 | - |
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14614 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
