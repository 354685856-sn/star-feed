...
- Owner: `354685856-sn`
- Total stars: `10`
- Generated: `2026-08-17T13:04:28Z`
- Languages: TypeScript (4), Python (4), Unknown (1), Shell (1)
- HTTP date: `Mon, 17 Aug 2026 13:04:28 +0000`
...
| [coleam00/claude-memory-compiler](https://github.com/coleam00/claude-memory-compiler) | Python | 1277 | Give Claude Code a memory that evolves with your codebase. Hooks automatically capture sessions, the Claude Agent SDK extracts key decisions and lessons, and an LLM compiler organizes everything into structured, cross-referenced knowledge articles - inspired by Karpathy's LLM Knowledge Base architecture. |
| [coleam00/second-brain-starter](https://github.com/coleam00/second-brain-starter) | Unknown | 737 | Build your own AI Second Brain with Claude Code - a skill that generates a personalized PRD for a proactive, persistent AI assistant |
...
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14821 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
