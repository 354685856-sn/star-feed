...
- Owner: `354685856-sn`
- Total stars: `9`
- Generated: `2026-07-10T14:50:58Z`
- Languages: TypeScript (3), Python (3), Rust (1), Unknown (1), Shell (1)
- HTTP date: `Fri, 10 Jul 2026 14:50:58 +0000`
...
| [xingranya/GitHub-Stars-AI-Tools](https://github.com/xingranya/GitHub-Stars-AI-Tools) | TypeScript | 63 | 本地优先的 GitHub Stars AI 桌面应用，可 AI 检索/解析已 Star 项目。Local-first AI desktop app for GitHub Stars. |
...
| [heyitsnoah/claudesidian](https://github.com/heyitsnoah/claudesidian) | Python | 2528 | - |
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 13817 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
