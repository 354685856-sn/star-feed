...
- Owner: `354685856-sn`
- Total stars: `10`
- Generated: `2026-08-14T13:41:22Z`
- Languages: TypeScript (4), Python (4), Unknown (1), Shell (1)
- HTTP date: `Fri, 14 Aug 2026 13:41:22 +0000`
...
| [iansinnott/obsidian-claude-code-mcp](https://github.com/iansinnott/obsidian-claude-code-mcp) | TypeScript | 336 | Connect Claude Code and other AI tools to your Obsidian notes using Model Context Protocol (MCP) |
...
| [ballred/obsidian-claude-pkm](https://github.com/ballred/obsidian-claude-pkm) | Shell | 1808 | A complete starter kit for an Obsidian + Claude Code personal knowledge management system. |
| [heyitsnoah/claudesidian](https://github.com/heyitsnoah/claudesidian) | Python | 2565 | - |
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14773 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
