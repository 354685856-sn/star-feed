...
- Owner: `354685856-sn`
- Total stars: `9`
- Generated: `2026-08-01T19:32:45Z`
- Languages: Python (4), TypeScript (3), Unknown (1), Shell (1)
- HTTP date: `Sat, 01 Aug 2026 19:32:45 +0000`
...
| [xingranya/GitHub-Stars-AI-Tools](https://github.com/xingranya/GitHub-Stars-AI-Tools) | TypeScript | 82 | 本地优先的 GitHub Stars AI 桌面应用，可 AI 检索/解析已 Star 项目。Local-first AI desktop app for GitHub Stars. |
...
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14478 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
