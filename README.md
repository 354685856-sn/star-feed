...
- Owner: `354685856-sn`
- Total stars: `10`
- Generated: `2026-07-11T08:14:24Z`
- Languages: Python (4), TypeScript (3), Rust (1), Unknown (1), Shell (1)
- HTTP date: `Sat, 11 Jul 2026 08:14:24 +0000`
...
| [coleam00/claude-memory-compiler](https://github.com/coleam00/claude-memory-compiler) | Python | 1239 | Give Claude Code a memory that evolves with your codebase. Hooks automatically capture sessions, the Claude Agent SDK extracts key decisions and lessons, and an LLM compiler organizes everything into structured, cross-referenced knowledge articles - inspired by Karpathy's LLM Knowledge Base architecture. |
...
| [ballred/obsidian-claude-pkm](https://github.com/ballred/obsidian-claude-pkm) | Shell | 1559 | A complete starter kit for an Obsidian + Claude Code personal knowledge management system. |
| [heyitsnoah/claudesidian](https://github.com/heyitsnoah/claudesidian) | Python | 2529 | - |
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 13838 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
