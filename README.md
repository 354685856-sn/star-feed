...
- Owner: `354685856-sn`
- Total stars: `10`
- Generated: `2026-07-13T09:47:19Z`
- Languages: Python (4), TypeScript (3), Rust (1), Unknown (1), Shell (1)
- HTTP date: `Mon, 13 Jul 2026 09:47:19 +0000`
...
| [xingranya/GitHub-Stars-AI-Tools](https://github.com/xingranya/GitHub-Stars-AI-Tools) | TypeScript | 67 | 本地优先的 GitHub Stars AI 桌面应用，可 AI 检索/解析已 Star 项目。Local-first AI desktop app for GitHub Stars. |
...
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 13960 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
