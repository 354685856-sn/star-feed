...
- Owner: `354685856-sn`
- Total stars: `9`
- Generated: `2026-07-27T10:08:11Z`
- Languages: Python (4), TypeScript (3), Unknown (1), Shell (1)
- HTTP date: `Mon, 27 Jul 2026 10:08:11 +0000`
...
| [coleam00/claude-memory-compiler](https://github.com/coleam00/claude-memory-compiler) | Python | 1258 | Give Claude Code a memory that evolves with your codebase. Hooks automatically capture sessions, the Claude Agent SDK extracts key decisions and lessons, and an LLM compiler organizes everything into structured, cross-referenced knowledge articles - inspired by Karpathy's LLM Knowledge Base architecture. |
| [coleam00/second-brain-starter](https://github.com/coleam00/second-brain-starter) | Unknown | 700 | Build your own AI Second Brain with Claude Code - a skill that generates a personalized PRD for a proactive, persistent AI assistant |
...
| [heyitsnoah/claudesidian](https://github.com/heyitsnoah/claudesidian) | Python | 2550 | - |
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14358 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
