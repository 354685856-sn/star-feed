...
- Owner: `354685856-sn`
- Total stars: `10`
- Generated: `2026-08-13T13:46:00Z`
- Languages: TypeScript (4), Python (4), Unknown (1), Shell (1)
- HTTP date: `Thu, 13 Aug 2026 13:46:00 +0000`
...
| [ballred/obsidian-claude-pkm](https://github.com/ballred/obsidian-claude-pkm) | Shell | 1777 | A complete starter kit for an Obsidian + Claude Code personal knowledge management system. |
| [heyitsnoah/claudesidian](https://github.com/heyitsnoah/claudesidian) | Python | 2564 | - |
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14750 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
