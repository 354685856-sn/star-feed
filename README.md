...
- Owner: `354685856-sn`
- Total stars: `9`
- Generated: `2026-07-24T08:41:31Z`
- Languages: Python (4), TypeScript (3), Unknown (1), Shell (1)
- HTTP date: `Fri, 24 Jul 2026 08:41:31 +0000`
...
| [coleam00/claude-memory-compiler](https://github.com/coleam00/claude-memory-compiler) | Python | 1254 | Give Claude Code a memory that evolves with your codebase. Hooks automatically capture sessions, the Claude Agent SDK extracts key decisions and lessons, and an LLM compiler organizes everything into structured, cross-referenced knowledge articles - inspired by Karpathy's LLM Knowledge Base architecture. |
...
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 14298 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
