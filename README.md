...
- Owner: `354685856-sn`
- Total stars: `9`
- Generated: `2026-07-09T20:03:46Z`
- Languages: TypeScript (3), Python (3), Rust (1), Unknown (1), Shell (1)
- HTTP date: `Thu, 09 Jul 2026 20:03:46 +0000`
...
| [xingranya/GitHub-Stars-AI-Tools](https://github.com/xingranya/GitHub-Stars-AI-Tools) | TypeScript | 60 | 本地优先的 GitHub Stars AI 桌面应用，可 AI 检索/解析已 Star 项目。Local-first AI desktop app for GitHub Stars. |
...
| [coleam00/claude-memory-compiler](https://github.com/coleam00/claude-memory-compiler) | Python | 1236 | Give Claude Code a memory that evolves with your codebase. Hooks automatically capture sessions, the Claude Agent SDK extracts key decisions and lessons, and an LLM compiler organizes everything into structured, cross-referenced knowledge articles - inspired by Karpathy's LLM Knowledge Base architecture. |
...
| [heyitsnoah/claudesidian](https://github.com/heyitsnoah/claudesidian) | Python | 2525 | - |
| [YishenTu/claudian](https://github.com/YishenTu/claudian) | TypeScript | 13792 | An Obsidian plugin that embeds Claude Code/Codex as an AI collaborator in your vault |
